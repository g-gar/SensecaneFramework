...
public class MySQLConnectionProperties extends BaseEntity implements ConnectionProperties {
	...
	public MySQLConnectionProperties(String serverUri, String username, String password, String schema) {
